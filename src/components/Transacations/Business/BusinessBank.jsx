...
export default function BusinessMobile(props) {
  ...
  const [receipientBusinessName, setReceipientBusinessName] = useState('Tilly Tires Ltd')
  ...
  const [businessAddressCountryCode, setBusinessAddressCountryCode] = useState('NG')
  const [businessPrimaryContactCountryCode, setBusinessPrimaryContactCountryCode] = useState('NG')
  const [businessPrimaryContactNo, setBusinessPrimaryContactNo] = useState('3472034605')
  const [receipientBusinessPrimaryContactCountryCode, setReceipientBusinessPrimaryContactCountryCode] = useState('NG')
  const [receipientBusinessPrimaryContactNo, setReceipientBusinessPrimaryContactNo] = useState('3472034605')
  const [receipientBusinessPrimaryContactNoType, setReceipientBusinessPrimaryContactNoType] = useState('Mobile')
  const [businessDescription, setBusinessDescription] = useState('Electronics')
  const [receipientBusinessDescription, setreceipientBusinessDescription] = useState('Electronics wholesale')
  const [businessCountryCode, setBusinessCountryCode] = useState('US')
  const [receipientBusinessCountryCode, setreceipientBusinessCountryCode] = useState('NG')
  ...
  const [receipientBusinessEmail, setReceipientBusinessEmail] = useState('rs.electronics@gmail.com')
  const [primaryContactCountryCode, setPrimaryContactcountryCode] = useState('')
  ...
  const [personalePrimaryContactNoCode, setPersonalPrimaryContactNoCode] = useState('KE')
  const [primaryContactNoType, setPrimaryContactNoType] = useState('')
      ...
      <Stack spacing={4} justifyContent='space-between' direction='row'>
        ...
        <Stack spacing={4} width={450}>
          ...
          <Stack alignItems='center' justifyContent='space-between' direction='row'>
            ...
            <OutlinedInput sx={{ height: 40,width:200 }} placeholder='Bank Sub-Code' value={bankSubCode} onChange={({ target }) => setBankSubCode(target.value)} />
          </Stack>
          <Stack alignItems='center' justifyContent='space-between' direction='row'>
            <Typography color="#575757" fontWeight='500'>
              Receiving Country
          ...
          {(transactionType === 'b2b' || transactionType === 'p2b') && <>
            ...
            <Stack alignItems='center' justifyContent='space-between' direction='row'>
              ...
              <OutlinedInput sx={{ height: 40,width:200 }} placeholder='Account IBAN Number' value={accountIBAN} onChange={({ target }) => setAccountIBAN(target.value)} />
            </Stack>
          </>}
          <Stack alignItems='center' justifyContent='space-between' direction='row'>
            <Typography color="#575757" fontWeight='500'>
            ...
            <OutlinedInput sx={{ height: 40,width:200 }} placeholder='Account Name' value={accountName} onChange={({ target }) => setAccountName(target.value)} />
          </Stack>
          ...
          <Stack alignItems='center' justifyContent='space-between' direction='row'>
            ...
            <OutlinedInput sx={{ height: 40,width:200 }} placeholder='Account Additional No1' value={accountAdditionalNo1} onChange={({ target }) => setAccountAdditionalNo1(target.value)} />
          </Stack>
        ...
        <Stack spacing={4} width={450}>
          ...
          {(transactionType === 'b2b' || transactionType === 'p2b') && <>
            ...
            <Stack alignItems='center' justifyContent='space-between' direction='row'>
              ...
              <OutlinedInput sx={{ height: 40,width:200 }} placeholder='Receipient Type of Business' value={typeOfBusiness} onChange={({ target }) => setTypeOfBusiness(target.value)} />
            </Stack>
            <Stack alignItems='center' justifyContent='space-between' direction='row'>
              <Typography color="#575757" fontWeight='500'>
                Receipient Business PO Box
              </Typography>
              <OutlinedInput sx={{ height: 40,width:200 }} placeholder='Receipient Business PO Box' value={businessPObox} onChange={({ target }) => setBusinessPOBox(target.value)} />
            </Stack>
            <Stack alignItems='center' justifyContent='space-between' direction='row'>
              <Typography color="#575757" fontWeight='500'>
                Receipient Business Mobile
              </Typography>
              <OutlinedInput sx={{ height: 40,width:200 }} placeholder='Receipient Business Mobile' value={receipientBusinessMobile} onChange={({ target }) => setReceipientBusinessMobile(target.value)} />
            </Stack> </>}
          {/* <Stack alignItems='center' justifyContent='space-between' direction='row'>
              <Typography color="#575757" fontWeight='500'>
                Business Address City
          ...
          <Stack alignItems='center' justifyContent='space-between' direction='row'>
            ...
            <OutlinedInput sx={{ height: 40,width:200 }} placeholder='Sender Relationship' value={senderRelation} onChange={({ target }) => setSenderRelation(target.value)} />
          </Stack>
        </Stack>
      </Stack>
