...
export default function TransactionBankStatusPopup(props) {
    ...
    >
      <DialogTitle>
        ...
        <Stack alignItems='center' justifyContent='center' direction='row' pb={1}>
          <Typography variant='h6' fontFamily='Poppins' fontWeight='600'> Transaction Bank Status</Typography>
        </Stack>
      </DialogTitle>
       ...
       {/*  <Stack direction="column" spacing={2} textAlign="right" >
        ...
        <TableContainer component={Paper}>
              ...
              <StyledTableRow>
                  ...
                  <StyledTableRow>
                    <StyledTableCell component="th" scope="row" >Beneficiary Bank Account</StyledTableCell>
                    <StyledTableCell align="left">{props.accountNr}
                    </StyledTableCell>
                  </StyledTableRow>
                  <StyledTableRow>
                    <StyledTableCell component="th" scope="row" >Full name of beneficiary bank</StyledTableCell>
                    <StyledTableCell align="left">{props.kycName}
                    </StyledTableCell>
                  </StyledTableRow>
                  <StyledTableRow>
                    <StyledTableCell component="th" scope="row" >Bank Code</StyledTableCell>
                    <StyledTableCell align="left">{props.bankCode}
                    </StyledTableCell>
                  </StyledTableRow>
                  <StyledTableRow>
                  ...
                  <StyledTableRow>
                    ...
                    <StyledTableCell align="left">{props.nationality}</StyledTableCell>
                  </StyledTableRow>
                  <StyledTableRow>
                    <StyledTableCell component="th" scope="row" >Date of Birth</StyledTableCell>
                    <StyledTableCell align="left">{props.dob}</StyledTableCell>
                  </StyledTableRow>
                  <StyledTableRow>
